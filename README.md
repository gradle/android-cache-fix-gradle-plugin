...
dependencies {
    // ...
    implementation("org.gradle.android.cache-fix:org.gradle.android.cache-fix.gradle.plugin:2.5.4")
    // ...
}
...
If you are not using convention plugins and would like a quick way of testing the plugin you can alternatively place it in the root project's build.gradle (change '2.5.4' to the latest version of the cache fix plugin
...
```groovy
plugins {
    id "org.gradle.android.cache-fix" version "2.5.4" apply false
}
