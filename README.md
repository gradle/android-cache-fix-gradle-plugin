...
this can just be injected from the root project's build.gradle (change '2.4.0' to the latest version of the cache fix plugin
...
```groovy
plugins {
    id "org.gradle.android.cache-fix" version "2.4.0" apply false
}
