...
* Supported Android Gradle Plugin versions: 7.0.4, 7.1.3, 7.2.2, 7.3.0, 7.4.0-alpha10, 8.0.0-alpha01
...
dependencies {
    // ...
    implementation("org.gradle.android.cache-fix:org.gradle.android.cache-fix.gradle.plugin:2.5.7")
    // ...
}
...
If you are not using convention plugins and would like a quick way of testing the plugin you can alternatively place it in the root project's build.gradle (change '2.5.7' to the latest version of the cache fix plugin
...
```groovy
plugins {
    id "org.gradle.android.cache-fix" version "2.5.7" apply false
}
