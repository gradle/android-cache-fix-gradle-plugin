...
class CrossVersionOutcomeAndRelocationTest extends AbstractTest {
    ...
    private static ExpectedResults expectedResults(VersionNumber androidVersion, GradleVersion gradleVersion) {
        ...
        def isAndroid35xTo36x= androidVersion >= android("3.5.0") && androidVersion <= android("3.6.2")
    ...
    static void android35xOrHigherExpectations(ExpectedOutcomeBuilder builder) {
        ...
        builder.expect(':app:compileDebugRenderscript', NO_SOURCE)
        ...
        builder.expect(':app:compileReleaseRenderscript', NO_SOURCE)
        ...
        builder.expect(':library:compileDebugRenderscript', NO_SOURCE)
        ...
        builder.expect(':library:compileReleaseRenderscript', NO_SOURCE)
