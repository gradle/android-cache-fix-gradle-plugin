...
class WorkaroundTest extends Specification {
    ...
    def "applies the right workarounds for Android #androidVersion"() {
        ...
        "8.1.0-alpha04" | ['MergeSourceSetFolders', 'RoomSchemaLocation', 'ZipMergingTask', 'JdkImage']
        "8.0.0-beta02"  | ['MergeSourceSetFolders', 'RoomSchemaLocation', 'ZipMergingTask', 'JdkImage']
        "7.4.1"         | ['MergeSourceSetFolders', 'RoomSchemaLocation', 'ZipMergingTask', 'JdkImage']
