...
class WorkaroundTest extends Specification {
    ...
    def "applies the right workarounds for Android #androidVersion"() {
        ...
        "8.2.0-alpha02" | ['MergeSourceSetFolders', 'RoomSchemaLocation', 'ZipMergingTask', 'JdkImage']
        "8.1.0-beta02" | ['MergeSourceSetFolders', 'RoomSchemaLocation', 'ZipMergingTask', 'JdkImage']
